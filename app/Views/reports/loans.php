...
<?= $this->section('head') ?>
<title>Data Cetak Peminjaman</title>
<?= $this->endSection() ?>
  ...
  <div class="card-body">
    <div class="row mb-2">
      <div class="col-12 col-lg-5">
        <h5 class="card-title fw-semibold mb-4">Data Cetak Peminjaman</h5>
      </div>
        ...
        <div class="d-flex gap-2 justify-content-md-end">
          <div>
            <form action="" method="get">
              <div class="row mb-3">
                <div class="col-md-12">
                  <input type="text" class="form-control" name="search" value="<?= $search ?? ''; ?>" placeholder="Cari cetak peminjaman" aria-label="Cari cetak peminjaman" aria-describedby="searchButton">
                </div>
              </div>
              <div class="row mb-3">
                ...
                <div class="col-md-6 d-grid">
                  <a href="<?= base_url('reports/report_loans') . '?search=' . $search . '&loan_date_from=' . $loanDateFrom . '&loan_date_to=' . $loanDateTo . '&due_date_from=' . $dueDateFrom . '&due_date_to=' . $dueDateTo . '&return_date_from=' . $returnDateFrom . '&return_date_to=' . $returnDateTo; ?>" class="btn btn-primary py-2">
