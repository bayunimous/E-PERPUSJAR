          ...
          <div>
            <form action="" method="get">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6 d-grid">
                  <a href="<?= base_url('reports/report_loans') . '?loan_date_from=' . $loanDateFrom . '&loan_date_to=' . $loanDateTo . '&due_date_from=' . $dueDateFrom . '&due_date_to=' . $dueDateTo . '&return_date_from=' . $returnDateFrom . '&return_date_to=' . $returnDateTo; ?>" class="btn btn-primary py-2">
