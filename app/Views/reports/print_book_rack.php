...
<head>
    ...
    <title>Laporan Rak Buku Terlaris</title>
    <style>
...
<body>
    ...
    <div class="mt-5">
        ...
        <div class="card">
            <div class="card-body">
                <h2 class="card-title fw-bold mb-4 text-center">Laporan Data Rak Buku Terlaris</h2>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $rack['name']; ?></td>
                                    <td><?= $rack['floor']; ?></td>
                                    <td><?= $bookCountInRacks[$rack['id']] ?? 0; ?></td>
                                    <td class="text-center"><?= $rack['total_loans'] ?? 0; ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
