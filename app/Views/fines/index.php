    ...
    <div class="row mb-2">
      ...
      <div class="col-12 mb-3">
        <div class="d-flex gap-2">
          ...
          <div>
            <a href="<?= $paidOffFilter ? base_url('fines?paid-off=false') : '#'; ?>" class="btn btn<?= $paidOffFilter ? '-outline' : ''; ?>-warning py-2">
          ...
          <div>
            <a href="<?= $paidOffFilter ? '#' : base_url('fines?paid-off=true'); ?>" class="btn btn<?= $paidOffFilter ? '' : '-outline'; ?>-success py-2">
              <?php if ($paidOffFilter) : ?>
                <i class="ti ti-check"></i>
              <?php endif; ?>
              Lunas
      ...
      <tbody class="table-group-divider">
        ...
        ?>
          <tr>
            <th scope="row"><?= $i++; ?></th>
            <td>
              <a href="<?= base_url("members/{$fine['member_uid']}"); ?>" class="text-decoration-underline">
                <p>
            ...
            <td>
              ...
              <?php if (!$paidOffFilter && $fine['amount_paid'] < $fine['fine_amount']) : ?>
                <a href="<?= base_url("fines/pay/{$fine['uid']}"); ?>" class="d-block btn btn-warning w-100 mb-2">
                  Bayar
                </a>
              <?php endif; ?>
              <?php endif; ?>
              <a href="<?= base_url("returns/{$fine['uid']}"); ?>" class="d-block btn btn-primary w-100 mb-2">
                Detail
              </a>
            </td>
          </tr>
