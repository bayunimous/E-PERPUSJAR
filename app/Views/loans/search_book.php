...
<a href="<?= base_url('loans/new/members/search'); ?>" class="btn btn-outline-primary mb-3">
...
<div class="card">
  <div class="card-body">
    ...
    <div class="my-4">
      ...
      <form id="bookForm" action="<?= base_url('loans/new'); ?>" method="post">
        <?= csrf_field(); ?>
...
<script>
  function getBookData(param) {
    jQuery.ajax({
      url: "<?= base_url('loans/new/books/search'); ?>",
      type: 'get',
      data: {
        'param': param,
        'memberUid': '<?= $members['uid']; ?>'
      },
