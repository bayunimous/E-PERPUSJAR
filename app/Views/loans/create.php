...
<a href="<?= base_url('loans/new/books/search?member-uid=' . $members['uid']); ?>" class="btn btn-outline-primary mb-3">
  <i class="ti ti-arrow-left"></i>
  Kembali
</a>
<form action="<?= base_url('loans'); ?>" method="post">
  <?= csrf_field(); ?>
  <input type="hidden" name="member_uid" value="<?= $members['uid']; ?>">
  <!-- Member -->
  <div class="card">
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-12 col-md-6 mb-3">
          ...
          <input type="text" class="form-control" id="member_name" name="member_name" value="<?= "{$members['first_name']} {$members['last_name']}"; ?>" disabled>
        </div>
        <div class="col-12 col-md-6 mb-3">
          <label for="member_email" class="form-label">Email</label>
          <input type="text" class="form-control" id="member_email" name="member_email" value="<?= $members['email']; ?>" disabled>
        </div>
        <div class="col-12 col-md-6 mb-3">
          <label for="member_phone" class="form-label">Nomor telepon</label>
          <input type="text" class="form-control" id="member_phone" name="member_phone" value="<?= $members['phone']; ?>" disabled>
        </div>
        <div class="col-12 col-md-6 mb-3">
          <label for="member_address" class="form-label">Alamat</label>
          <input type="text" class="form-control" id="member_address" name="member_address" value="<?= $members['address']; ?>" disabled>
        </div>
      </div>
    </div>
  </div>
