...
<a href="<?= base_url('membersloan'); ?>" class="btn btn-outline-primary mb-3">
...
<div class="card">
  <div class="card-body">
    ...
    <div class="my-4">
      ...
      <form id="bookForm" action="<?= base_url('membersloan/new'); ?>" method="post">
        <?= csrf_field(); ?>
...
<script>
  function getBookData(param) {
    jQuery.ajax({
      url: "<?= base_url('membersloan/new/books/search'); ?>",
      type: 'get',
      data: {
        'param': param,
