...
<div class="card">
  <div class="card-body">
    ...
    <div class="row mb-2">
      ...
      <div class="col-12 col-lg-7">
        <div class="d-flex gap-2 justify-content-md-end">
          ...
          <div>
            <a href="<?= base_url('membersloan/new/books/search'); ?>?member-uid=<?= $member['uid']; ?>" class="btn btn-primary py-2">
      ...
      <tbody class="table-group-divider">
        ...
        ?>
          <tr>
            ...
            <td>
              <a href="<?= base_url("membersloan/{$loan['uid']}"); ?>" class="d-block btn btn-primary w-100 mb-2">
                Detail
              </a>
            </td>
          </tr>
    ...
    <?= $pager->links('membersloan', 'my_pager'); ?>
  </div>
</div>
<?= $this->endSection() ?>