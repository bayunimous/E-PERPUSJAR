    ...
    <div class="row mb-2">
      ...
      <div class="col-12 col-lg-7">
        <div class="d-flex gap-2 justify-content-md-end">
          ...
          <div>
            <a href="<?= base_url('members/new'); ?>" class="btn btn-primary py-2">
      ...
      <tbody class="table-group-divider">
        ...
        <?php foreach ($members as $key => $member) : ?>
          <tr>
            <th scope="row"><?= $i++; ?></th>
            <td>
              <a href="<?= base_url("members/{$member['uid']}"); ?>" class="text-primary-emphasis text-decoration-underline">
            ...
            <td>
              <div class="d-flex justify-content-center gap-2">
                <a href="<?= base_url("members/{$member['uid']}/edit"); ?>" class="btn btn-primary mb-2">
                  Edit
                </a>
                <form action="<?= base_url("members/{$member['uid']}"); ?>" method="post">
                  <?= csrf_field(); ?>
