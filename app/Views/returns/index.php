    ...
    <div class="row mb-2">
      ...
      <div class="col-12 col-lg-7">
        <div class="d-flex gap-2 justify-content-md-end">
          ...
          <div>
            <a href="<?= base_url('returns/new/search'); ?>" class="btn btn-primary py-2">
      ...
      <tbody class="table-group-divider">
        ...
        ?>
          <tr>
            <th scope="row"><?= $i++; ?></th>
            <td>
              <a href="<?= base_url("members/{$loan['member_uid']}"); ?>" class="text-primary-emphasis text-decoration-underline">
                <p>
            ...
            <td>
              <a href="<?= base_url("books/{$loan['slug']}"); ?>">
            ...
            <td class="text-center">
              <?php if ($loan['status_return'] == 'Setuju') : ?>
                <span class="badge bg-success rounded-3 fw-semibold">Setuju</span>
              <?php elseif ($loan['status_return'] == 'Proses') : ?>
                <span class="badge bg-warning rounded-3 fw-semibold">Proses</span>
              <?php elseif ($loan['status_return'] == 'Tolak') : ?>
                <span class="badge bg-danger rounded-3 fw-semibold">Tolak</span>
              <?php else : ?>
            ...
            <td>
              <a href="<?= base_url("returns/{$loan['uid']}"); ?>" class="d-block btn btn-primary w-100 mb-2">
                Detail
              </a>
            </td>
          </tr>
