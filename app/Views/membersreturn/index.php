  ...
  <div class="card-body">
    <div class="row mb-2">
      ...
      <div class="col-12 col-lg-7">
        <div class="d-flex gap-2 justify-content-md-end">
          ...
          <div>
            <a href="<?= base_url('membersreturn/new/search'); ?>" class="btn btn-primary py-2">
    ...
    <table class="table table-hover table-striped">
      ...
      <tbody class="table-group-divider">
        ...
        <?php if (empty($loans)) : ?>
          <tr>
            <td class="text-center" colspan="10"><b>Tidak ada data</b></td>
          </tr>
        <?php endif; ?>
        <?php
        ...
        ?>
          <tr>
            ...
            <td>
              <a href="<?= base_url("membersreturn/{$loan['uid']}"); ?>" class="d-block btn btn-primary w-100 mb-2">
                Detail
              </a>
            </td>
          </tr>
