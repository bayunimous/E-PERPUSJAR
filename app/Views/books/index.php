    ...
    <div class="row mb-2">
      ...
      <div class="col-12 col-lg-7">
        <div class="d-flex gap-2 justify-content-md-end">
          ...
          <div>
            <a href="<?= base_url('books/new'); ?>" class="btn btn-primary py-2">
      ...
      <tbody class="table-group-divider">
        ...
        <?php foreach ($books as $book) : ?>
          <tr>
            ...
            <?php if ($user['role'] !== 'Kepala Dinas') : ?>
            <td>
              <a href="<?= base_url("books/{$book['slug']}/edit"); ?>" class="d-block btn btn-primary w-100 mb-2">
                <i class="ti ti-edit"></i>
                Edit
              </a>
              <form action="<?= base_url("books/{$book['slug']}"); ?>" method="post">
                <?= csrf_field(); ?>
