      ...
      <tbody class="table-group-divider">
        ...
        <?php foreach ($categories as $key => $category) : ?>
          <tr>
            <th scope="row"><?= $i++; ?></th>
            <td>
              <a href="<?= base_url("categories/{$category['id']}"); ?>" class="text-primary-emphasis text-decoration-underline">
                <b><?= $category['name']; ?></b>
              </a>
            </td>
            ...
            <td>
              <div class="d-flex justify-content-center gap-2">
                <a href="<?= base_url("categories/{$category['id']}/edit"); ?>" class="btn btn-primary mb-2">
