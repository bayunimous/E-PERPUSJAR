...
<head>
    ...
    <title>Laporan Pelayanan Petugas</title>
...
<body>
    ...
    <div class="mt-5">
        ...
        <div class="card">
            <div class="card-body">
                <!-- Report title -->
                <h2 class="card-title fw-bold mb-4 text-center">Laporan Data Pelayanan Petugas</h2>
                        ...
                        <tbody>
                            <?php foreach ($performances as $key => $performance) : ?>
                                <tr>
                                    ...
                                    <td><?= nl2br($performance['description']); ?></td>
