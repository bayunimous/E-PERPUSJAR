...
class DashboardController extends BaseController
{
    ...
    protected function getReports(): array
    {
        ...
        $newLoansToday = $this->loanModel
            ->where("created_at BETWEEN '{$todayMidnight}' AND '{$tomorrowMidnight}' AND status_loan = 'Setuju'")
            ->findAll();

        $newBookReturnsToday = $this->loanModel
            ->where("return_date BETWEEN '{$todayMidnight}' AND '{$tomorrowMidnight}' AND status_loan = 'Setuju'")
            ->findAll();
